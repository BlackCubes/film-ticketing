 ...
 * https://modernizr.com/download/?-canvas-csstransforms-setclasses !*/
!function (e, n, t, r) {
  function o(e, n) {
    return _typeof(e) === n;
  }
  ...
  function l(e, n, r, o) {
    ...
    return i = s("style"), i.type = "text/css", i.id = "s" + c, (p.fake ? p : d).appendChild(i), p.appendChild(d), i.styleSheet ? i.styleSheet.cssText = e : i.appendChild(t.createTextNode(e)), d.id = c, p.fake && (p.style.background = "", p.style.overflow = "hidden", u = S.style.overflow, S.style.overflow = "hidden", S.appendChild(p)), l = n(d, e), p.fake ? (p.parentNode.removeChild(p), S.style.overflow = u, S.offsetHeight) : d.parentNode.removeChild(d), !!l;
  }
  ...
  function p(e, n, t, a) {
    ...
    for (var u, p, m, v, y, g = ["modernizr", "tspan", "samp"]; !z.style && g.length;) {
      u = !0, z.modElem = s(g.shift()), z.style = z.modElem.style;
    }

    for (m = e.length, p = 0; p < m; p++) {
      if (v = e[p], y = z.style[v], i(v, "-") && (v = d(v)), z.style[v] !== r) {
        ...
        if (z.style[v] !== y) return l(), "pfx" !== n || v;
      }
    }
  ...
  function v(e, n, t) {
    ...
    for (var s in e) {
      if (e[s] in n) return !1 === t ? e[s] : (r = n[e[s]], o(r, "function") ? m(r, t || n) : r);
    }
  ...
  function y(e, n, t, r, s) {
    ...
    return o(n, "string") || o(n, "undefined") ? p(a, n, r, s) : (a = (e + " " + E.join(i + " ") + i).split(" "), v(a, n, t));
  }
  ...
  C._domPrefixes = E, C.testAllProps = y, C.testAllProps = g, Modernizr.addTest("csstransforms", function () {
    ...
    for (var l in h) {
      if (h.hasOwnProperty(l)) {
        ...
        for (r = o(n.fn, "function") ? n.fn() : n.fn, s = 0; s < e.length; s++) {
          i = e[s], a = i.split("."), 1 === a.length ? Modernizr[a[0]] = r : (Modernizr[a[0]] && (!Modernizr[a[0]] || Modernizr[a[0]] instanceof Boolean) || (Modernizr[a[0]] = new Boolean(Modernizr[a[0]])), Modernizr[a[0]][a[1]] = r), w.push((r ? "" : "no-") + a.join("-"));
        }
      }
    }
  }(), function (e) {
...
},{"./gsap-core.js":"../../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../../node_modules/gsap/CSSPlugin.js"}],"../../node_modules/lax.js/lib/lax.min.js":[function(require,module,exports) {
...
exports.displayHomeMap = exports.displayMap = void 0;

/* eslint-disable */
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYmxhY2tjdWJlcyIsImEiOiJjazc4MHQxeXAwZG5rM2ltOWc1NTV4dXY3In0.1HJOv2jH1Vg_GsXhiIWOkw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/blackcubes/ck8f2ekqy0rzk1iljn5bg3fn6',
    minZoom: 10,
    maxZoom: 19 // interactive: false,
    // zoom: 10,
    // scrollZoom: false
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.geo.coordinates).addTo(map); // Add popup

    new mapboxgl.Popup({
      offset: 30,
      closeOnClick: false
    }).setLngLat(loc.geo.coordinates).setHTML("<p class=\"map-paragraph\">".concat(loc.name, "</p>")).addTo(map); // Extend map bounds to include current location
...
var displayHomeMap = function displayHomeMap() {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYmxhY2tjdWJlcyIsImEiOiJjazc4MHQxeXAwZG5rM2ltOWc1NTV4dXY3In0.1HJOv2jH1Vg_GsXhiIWOkw';
  var geoJson = {
  ...
  geoJson.features.forEach(function (marker) {
    ...
    new mapboxgl.Popup({
      offset: 30,
      closeOnClick: false
    }).setLngLat(marker.geometry.coordinates).setHTML('<p class="map-paragraph">' + marker.properties.description + '</p>').addTo(map);
    ...
    map.addLayer({
      ...
      source: {
        ...
        data: {
          ...
          geometry: {
            type: 'LineString',
            coordinates: [[-118.449444, 34.062678], [-118.2505173, 34.050838], [-118.3911507, 33.903495]]
          }
        }
      },
      layout: {
...
exports.displayHomeMap = displayHomeMap;
...
var CircleNav = /*#__PURE__*/function () {
  ...
  _createClass(CircleNav, [{
    key: "displayCircleNav",
    value: function displayCircleNav() {
      this.open = !this.open;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Welcome to the club!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var _multiForm4 = require("./multiForm");
...
var laxJs = document.getElementsByClassName('lax');
...
var adCreateShowtimeForm = document.getElementById('adCreateShowtimeForm'),
...
if (eoFieldlist1) {
  ...
  var _multiForm = new _multiForm4.MultiForm(_firstNextBtn, eoFieldlist1); // Initiate click event listeners for multiform with specific elements
...
if (adFieldlist1) {
  ...
  var _multiForm2 = new _multiForm4.MultiForm(_firstNextBtn2, adFieldlist1);
...
if (adCreateShowtimeForm) {
  adCreateShowtimeForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(e) {
      var shows, theaters, selectStartMonth, selectStartDay, selectStartYear, selectStartHour, selectStartMinute, selectStartSecond, selectEndHour, selectEndMinute, selectEndSecond, startMonth, startDay, startYear, startHour, startMinute, startSecond, endHour, endMinute, endSecond, startDateTime, endDateTime;
      return regeneratorRuntime.wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
...
if (updateTheaterMainView) {
  updateTheaterMainView.addEventListener('submit', /*#__PURE__*/function () {
    var _ref16 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee16(e) {
      var form, name, phone, linkUrl, updateTheaterDataBtn, photo, theaterId, photoUrlArr, photoParams;
      ...
      return regeneratorRuntime.wrap(function _callee20$(_context20) {
        while (1) {
          switch (_context20.prev = _context20.next) {
            ...
            case 9:
              document.getElementById('btnUpdateShowtimeData').textContent = 'Update Showtime Settings';
