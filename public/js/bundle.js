...
if (eoFieldlist1) {
  ...
  if (secondNextBtn) secondNextBtn.addEventListener('click', function (e) {
    return multiForm.buttonNext(e, false, false, true);
  });
  if (thirdNextBtn) thirdNextBtn.addEventListener('click', function (e) {
  ...
  var specialVenue = specialVenueValue === 'y' ? true : false,
      price = document.getElementById('showPrice').value; // const createShowBtn = document.getElementById('btnCreateShow');
  // if (createShowBtn) {
