...
!function (e, n, t, r) {
  ...
  function p(e, n, t, l) {
    ...
    for (var u, p, m, y, v, h = ["modernizr", "tspan", "samp"]; !z.style && h.length;) {
      u = !0, z.modElem = i(h.shift()), z.style = z.modElem.style;
    }

    for (m = e.length, p = 0; p < m; p++) {
      if (y = e[p], v = z.style[y], s(y, "-") && (y = d(y)), z.style[y] !== r) {
  ...
  function v(e, n, t, r, s) {
    ...
    return o(n, "string") || o(n, "undefined") ? p(l, n, r, s) : (l = (e + " " + E.join(i + " ") + i).split(" "), y(l, n, t));
  }
  ...
  C._domPrefixes = E, C.testAllProps = v, C.testAllProps = h, Modernizr.addTest("csstransforms", function () {
    ...
    for (var a in g) {
      if (g.hasOwnProperty(a)) {
        if (e = [], n = g[a], n.name && (e.push(n.name.toLowerCase()), n.options && n.options.aliases && n.options.aliases.length)) for (t = 0; t < n.options.aliases.length; t++) {
          e.push(n.options.aliases[t].toLowerCase());
        }

        for (r = o(n.fn, "function") ? n.fn() : n.fn, s = 0; s < e.length; s++) {
          i = e[s], l = i.split("."), 1 === l.length ? Modernizr[l[0]] = r : (Modernizr[l[0]] && (!Modernizr[l[0]] || Modernizr[l[0]] instanceof Boolean) || (Modernizr[l[0]] = new Boolean(Modernizr[l[0]])), Modernizr[l[0]][l[1]] = r), w.push((r ? "" : "no-") + l.join("-"));
        }
      }
    }
  }(), function (e) {
